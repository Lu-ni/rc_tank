...
void loop() {
  ...
  if (PS3.PS3Connected || PS3.PS3NavigationConnected) {
    ...
    if ((PS3.getAnalogButton(R2) > 2) && (PS3.getAnalogButton(L2) < 2)) { //marche avant
      vitesse_r2(); //action à faire quand R2 est pressé
    } else if ((PS3.getAnalogButton(L2) > 2) && (PS3.getAnalogButton(R2) < 2)) { //marche arrière
      vitesse_l2(); //action  à faire quand L2 est pressé
